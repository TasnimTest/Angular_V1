...
export class CompetenceComponent implements OnInit {
  ...
  allEmployeeSkills: EmployeeSkill[] = []; // Supposons que vous avez récupéré les compétences des employés depuis votre base de données
  employeeSkillsFiltered: EmployeeSkill[] = []; // Tableau pour stocker les compétences filtrées
  ...
  ngOnInit(): void {
    ...
    this.filterEmployeeSkillsByRole(); // Filtrer les compétences des employés par rôle lors de l'initialisation du composant
  }

  filterEmployeeSkillsByRole(): void {
    // Filtrer les compétences des employés ayant le rôle "Employé"
    this.employeeSkillsFiltered = this.allEmployeeSkills.filter(skill => skill['role'] === 'Employé');
  }
